package com.benyamephrem.math;

import com.benyamephrem.docgen.Doc;

import java.awt.geom.Point2D;

@Doc(
        desc = "This is a utility class for commonly used functions"
)
...
public class MathUtils {
    ...
    @Doc(
            desc = "Calculates distance between the given points",
            params = {"Coordinates of one point", "Coordinates of another point"},
            returnVal = "Returns the distance between the two points"
    )
    ...
    @Doc(
            desc = "Finds the roots of the equation",
            params = {"a", "b", "c"},
            returnVal = "Returns the roots of the equation"
    )
    ...
    @Doc(
            desc = "Displays value of Epsilon"
    )

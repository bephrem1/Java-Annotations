...
public class DocProcessor {
    ...
    public static boolean process(Class clazz) {
        ...
        //Pass in annotation class to tell compiler exactly what annotation you are looking for in clazz (the passed in class)
    ...
    private static int getNumMissingParams(Method method, Doc doc) {
        ...
        if (annotatedParamCount < paramCount) {
            ...
            numMissing = paramCount - annotatedParamCount;
        }
        return numMissing;
    }
